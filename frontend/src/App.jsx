...
export default function App() {
  ...
  return (
    // السر السحري هنا: overflow-clip بدل overflow-x-hidden عشان الـ sticky تشتغل
    <div className="min-h-screen font-sans relative flex flex-col bg-white overflow-clip">
      ...
      {/* ========================================================
          The Floating Navbar - Smooth & Lag-free
          ======================================================== */}
      <div className={`sticky top-0 z-[60] transition-all duration-300 ease-in-out ${scrolled ? 'pt-3 px-4' : 'pt-0 px-0'}`}>
        <header className={`mx-auto transition-all duration-300 ease-in-out ${
          scrolled 
            ? 'max-w-[1000px] bg-[#111111]/95 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.3)] rounded-full border border-white/10 px-6 py-2' 
          ...
          <div className="flex justify-between items-center h-12 md:h-14">
            ...
            <div className="flex-1 flex items-center">
              <img 
                ...
                className={`cursor-pointer object-contain transition-all duration-300 ${scrolled ? 'h-8 md:h-10' : 'h-12 md:h-16'}`}
            ...
            <nav className="hidden lg:flex space-x-2">
              <a 
                href="#flash-sale" 
                onClick={(e) => scrollToSection(e, 'flash-sale')} 
                className={`px-4 py-2 rounded-full text-sm font-semibold tracking-wider uppercase transition-colors duration-200 ${
                  scrolled ? 'text-gray-300 hover:bg-[#5C131C] hover:text-[#FAF8F5]' : 'text-[#5C131C] hover:bg-[#5C131C] hover:text-[#FAF8F5]'
                }`}
              >
                Flash Sale
              </a>
            ...
            <div className="flex-1 flex justify-end items-center space-x-2 md:space-x-4">
              <button 
                ...
                className={`p-2 rounded-full transition-colors duration-200 ${
                  scrolled ? 'text-gray-300 hover:bg-[#5C131C] hover:text-white' : 'text-[#5C131C] hover:bg-[#5C131C] hover:text-white'
                }`}
              >
      ...
      <main className="flex-grow bg-white">
        {activeCategory ? (
          ...
          <>
            {/* 1. Hero Section */}
            <section 
              className="relative w-full h-[85vh] md:h-[85vh] bg-black z-10 overflow-hidden flex items-center justify-center md:justify-start"
              ...
              <div className="absolute inset-0 flex items-center justify-center md:justify-start md:pl-24 z-20">
                <div className="text-center md:text-left text-white max-w-2xl px-6 animate-fade-in-up">
                  ...
                  <h2 className="text-5xl md:text-7xl font-serif font-bold mb-6 tracking-wide leading-tight drop-shadow-2xl">
                    Timeless. <br/> <span className="text-[#e2c78f] italic">Elegance.</span>
                  </h2>
                  <button 
                    onClick={(e) => scrollToSection(e, 'new-collection')}
                    className="mt-6 bg-[#FAF8F5] text-[#5C131C] px-10 py-4 uppercase tracking-widest text-sm font-bold hover:bg-[#e2c78f] transition-all duration-300 shadow-[0_0_15px_rgba(226,199,143,0.5)]"
                  >
                    Shop The Collection
                  </button>
                </div>
            ...
            {/* 3. New Collection Section (Sage/Light Green) */}
        ...
        <div className="max-w-[1400px] mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left mt-8 reveal-on-scroll">
          ...
          <div className="flex flex-col items-center md:items-start">
            <img 
              src="/images/logo.jpeg" 
              alt="Al-Haramain" 
              className="h-20 md:h-28 object-contain mb-6 cursor-pointer drop-shadow-xl" 
              onClick={handleLogoClick} 
            />
        ...
        <div className="fixed inset-0 z-[1000] flex justify-end bg-black/60 backdrop-blur-sm transition-opacity">
          <div className="w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-slide-in-right">
            <div className="p-6 flex justify-between items-center border-b border-[#e2c78f]/30 bg-[#FAF8F5]">
              ...
              <button onClick={() => setIsCartOpen(false)} className="text-gray-400 hover:text-[#5C131C] transition-colors">
            ...
            {cartItems.length > 0 && (
              <div className="p-6 bg-[#FAF8F5] border-t border-[#e2c78f]/30">
                ...
                <button 
                  ...
                  className="w-full bg-[#5C131C] text-[#FAF8F5] py-4 uppercase tracking-widest text-sm font-bold hover:bg-[#a68953] hover:text-white transition-colors flex justify-center items-center gap-2 shadow-xl rounded-sm"
                >
